...
import com.tongue.dandelioncourier.databinding.FragmentGoogleMapsBinding
import java.util.*

class GoogleMapsFragment(private val initialPosition: LatLng, private val callback: GoogleMapReadyCallBack?): Fragment(),
    OnMapReadyCallback {
    ...
    fun drawPolylineBetweenTwoPoints(p1: LatLng, p2: LatLng,p1Title: String, p2Title: String){
        mMap.addMarker(
            MarkerOptions()
                .position(p1)
                .title(p1Title)
    ...
    private fun drawCurvedPolyline(p1: LatLng, p2: LatLng, k: Double) {
        ...
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(c, 12f))
        // Polyline
